...
var extensionConfig = require("./config")
...
var setConfig = function(config){
	if(!config) 
		throw new Error("Missing application_api_key")
	...
	if(utils.isPlainObject(config)){
		if(!config.application_api_key) {
			throw new Error("Missing application_api_key")
		}
		config = utils.merge(extensionConfig.appConfig, config)
		return config
	}
